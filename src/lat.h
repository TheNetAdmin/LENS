...
#define LFS_ACCESS_MAX                  (1UL << LFS_ACCESS_MAX_BITS) // 512KB * 4096 (rng_array) = 2G
...
static task_desc_t task_desc[] = {
	...
	{"Overwrite Test",				"[stride_size]"},
	{"Pointer Chasing Write Test",			"[pc_region_size] [pc_block_size]"},
	{"Pointer Chasing Read and Write Test",		"[pc_region_size] [pc_block_size]"},
	{"Pointer Chasing Read after Write Test",	"[pc_region_size] [pc_block_size]"},
...
struct latency_sbi {
	...
	uint64_t write_size; /* TODO: WriteSize can be over 4GB */
