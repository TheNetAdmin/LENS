...
case "${host_name}" in
	...
	netserver*)
		...
		# Example `dmesg` output on this machine when executing `nvleak/scripts/utils/mount.sh`
		#### [    0.000000] user: [mem 0x0000001840000000-0x000000d53fffffff] persistent (type 7)
		#### [65507.126070] reportfs_fill_super: dax_supported = 0; bdev->super=0x0000000000000000
		#### [65507.126074] reportfs_fill_super: dev pmem0, phys_addr 0x400000000, virt_addr 0xffff933a40000000, size 17179869184
		#### [65507.133560] latencyfs_fill_super: dax_supported = 0; bdev->super=0x0000000000000000
		#### [65507.133564] latencyfs_fill_super: dev pmem1, phys_addr 0xc00000000, virt_addr 0xffff934240000000, size 17179869184
	...
	stormbreaker*)
		...
		export rep_dev="${rep_dev:-/dev/pmem0}"
		# lat_dev: The NVRAM-based PMEM device, created by `ipmctl` and `ndctl`
		export lat_dev="${lat_dev:-/dev/dax1.0}"
