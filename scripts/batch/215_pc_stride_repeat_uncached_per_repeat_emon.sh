...
# prev_region_array=(
#     $((2 ** 6)) $((2 ** 7)) $((2 ** 8)) $((2 ** 9))
#     $(seq -s ' ' $((2 ** 10)) $((2 ** 10)) $((2 ** 12 - 1))) # [  1KB,   4KB) per   1KB ->  3
#     $(seq -s ' ' $((2 ** 12)) $((2 ** 11)) $((2 ** 14 - 1))) # [  4KB,  16KB) per   2KB ->  6
#     $(seq -s ' ' $((2 ** 14)) $((2 ** 12)) $((2 ** 16 - 1))) # [ 16KB,  64KB) per   4KB -> 13
#     $(seq -s ' ' $((2 ** 16)) $((2 ** 14)) $((2 ** 19 - 1))) # [ 64KB, 512KB) per  16KB -> 31
#     $(seq -s ' ' $((2 ** 19)) $((2 ** 16)) $((2 ** 20 - 1))) # [512KB,   1MB) per  32KB -> 15
#     $((2 ** 20))
# )
# prev_region_array=(
#     $((2 ** 6)) $((2 ** 7)) $((2 ** 8)) $((2 ** 9))
